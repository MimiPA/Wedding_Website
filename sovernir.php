                ...
                <div class="tpp-categoryContainer">
                    <div class="tpp-categoryBox">
                        <div class="tpp-radioButtons">
                            ...
                            <?php
                            $data = mysqli_query($conn, "SELECT * FROM tabel_sovernir");
                            while ($d = mysqli_fetch_array($data)) {
                            ?>
                                <label class="custom-radio">
                                    <input type="radio" class="radioBtnClass" name="id_sovernir" value="<?= $d['id_sovernir']; ?>" />
                                    <div class="radio-btn">
                                        <h1><?= $d['nama_sovernir'] ?><br>Biaya : <?= $d['biaya_sovernir'] ?></h1>
                                        <img src="images/<?= $d['gambar_sovernir'] ?>" alt="">
                                    </div>
                                </label>
                            <?php
                            } ?>
